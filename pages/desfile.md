...
{% include feature/card.html header="Magia" text="La historia del rescaque es más bien una construcción, ya que no hay nada que indique que así sucediera" width="50" centered=true %}
